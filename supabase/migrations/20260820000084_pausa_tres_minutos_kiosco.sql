-- La pausa entre dos marcas de la misma cara en planta pasa de 2 a 3
-- minutos. Dos minutos alcanzaban para quien seguía en el óvalo; no
-- para quien ficha, se corre un paso y se asoma de nuevo creyendo que
-- eso era el egreso. Tres minutos dejan pasar a la cola. La salida
-- sigue sin horario: a los 3 minutos, la misma cara es egreso.
--
-- El 1:N, si esa persona ya fichó hace menos de 3 minutos, **devuelve
-- la marca que ya está** y no inserta otra. El 1:1 (celular) no tiene
-- esta pausa.
--
-- No cambia la firma.
...
comment on function public.fichar_con_rostro is
  ...
  '1:N, una marca de la misma persona de hace menos de 3 minutos se '
