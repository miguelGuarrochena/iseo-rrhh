              ...
              <form onSubmit={enviar} className="mt-7 flex flex-col gap-4">
                <label className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="rounded-xl border border-line-strong bg-surface px-4 py-3 text-base text-ink outline-none transition-colors placeholder:text-ink-soft/50 focus:border-brand-500 focus:shadow-[0_0_0_3px_rgba(74,122,245,0.18)]"
                  />
                </label>
